    ...
    <div className='footer'>
        ...
        <div className = "footer__elemento">
            ...
            <div className="footer__social">
                <a className="footer__social-icon" rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/elemento24"><i className="fab fa-facebook-square"></i></a>
                <a className="footer__social-icon" rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/elemento.24/"><i className="fab fa-instagram-square"></i></a>
                <a className="footer__social-icon" rel="noopener noreferrer" target="_blank" href="https://github.com/Elemento24"><i className="fab fa-github-square"></i></a>
                <a className="footer__social-icon" rel="noopener noreferrer" target="_blank" href="https://twitter.com/Vishesh30493930"><i className="fab fa-twitter-square"></i></a>
            </div>
        </div>
